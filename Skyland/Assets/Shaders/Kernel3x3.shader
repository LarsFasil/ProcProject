...
Shader "HvA_PostFX/Kernel3x3"
{
	Properties
	{
		...
		_SenTreshold ("Sensitivity Threshold", Range(1.0,1000.0)) = 1.0
	...
	SubShader
	{
		...
		Pass
		{
			...
			void SensitivityApply(){
				_KernelLine1 *= _SenTreshold;
				_KernelLine2.xz *= _SenTreshold;
				_KernelLine2.y = _KernelLine2.y * _SenTreshold + 1;
				_KernelLine3 *= _SenTreshold;
			}
